...
public class MainActivity extends Activity {
    ...
    t1.setText(isRussian 
        ...
        : "This app has the emergency mode. If you tap the app's notification, you will enable it. Ensure if the app has permission to show notifications, otherwise it won't appear. This mode locks the screen and asks the system to wipe data in case of any incorrect password entry on the lock screen (if you enter more than 4 characters and make at least 1 mistake).");
    root.addView(t1, lp);
